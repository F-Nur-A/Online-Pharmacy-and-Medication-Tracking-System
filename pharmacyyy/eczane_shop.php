...
FROM products
LEFT JOIN eczanestok ON products.ilaç_id = eczanestok.ilaç_id AND eczanestok.eczane_id = (SELECT eczane_id FROM eczane WHERE users = '$user_id')") or die('query failed');
