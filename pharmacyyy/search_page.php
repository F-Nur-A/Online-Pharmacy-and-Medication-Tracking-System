   ...
   <div class="box-container">
      ...
      <?php
        if (isset($_POST['search_btn'])) {
            ...
            $select_products = mysqli_query($conn, "SELECT products.*, depostok.stok_miktarı
         FROM products
         LEFT JOIN depostok ON products.ilaç_id = depostok.ilaç_id AND depostok.ed_id = (SELECT ed_id FROM eczadeposu WHERE users = '$user_id')
         ...
         ?>
               <form action="" method="POST" class="box">
                  <a href="eczane_depo_view_page.php?product_id=<?php echo $fetch_products['ilaç_id']; ?>" class="fas fa-eye"></a>
