...
$query = "SELECT * FROM `users` WHERE id = '$eczane_depo_id' AND user_type = 'eczane_depo'";
...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <?php
            $total_pendings = 0;
            $select_pendings = mysqli_query($conn, "SELECT * FROM `eczanesiparişleri` WHERE durum = 'beklemede' AND  depo_name = '$eczane_depo_name'") or die('query failed');
      ...
      <div class="box">
         <?php
            $total_completes = 0;
            $select_completes = mysqli_query($conn, "SELECT * FROM `eczanesiparişleri` WHERE durum = 'tamamlandı' AND depo_name = '$eczane_depo_name'") or die('query failed');
      ...
      <div class="box">
         <?php
            $select_admin = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = 'eczane_depo'") or die('query failed');
      ...
      <div class="box">
         <?php
            $select_account = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = 'eczane_depo' or user_type = 'kullanıcı'") or die('query failed');
