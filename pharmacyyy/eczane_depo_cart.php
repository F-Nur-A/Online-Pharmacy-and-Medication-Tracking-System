...
if(isset($_GET['delete'])){
    ...
    header('location:eczane_depo_cart.php');
}
...
<section class="shopping-cart">
    ...
    ?>
    <div  class="box">
        <a href="eczane_depo_cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('Sepetten silinsin mi?');"></a>
        <a href="eczane_depo_view_page.php?product_id=<?php echo $fetch_cart['product_id']; ?>" class="fas fa-eye"></a>
    ...
    <div class="more-btn">
        <a href="eczane_depo_cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('Sepetteki her şey silinsin mi?');">Tümünü Sil</a>
    </div>

    <div class="cart-total">
        <p>Sipariş Toplam Tutarı : <span><?php echo $grand_total; ?> TL</span></p>
        <a href="eczane_depo_shop.php" class="option-btn">Alışverişe Devam Et</a>
        <a href="eczane_depo_checkout.php" class="btn  <?php echo ($grand_total > 1)?'':'disabled' ?>">Ödeme İşlemine geç</a>
    </div>
